...
<header class="fixed top-0 left-0 w-full z-50">
    ...
    <nav class="flex items-center justify-between px-4 py-2 
        ...
        <a href="#accueil"
           class="text-2xl font-bold flex items-center justify-left gap-4 text-(--primary)">
        ...
        <div class="hidden md:flex gap-8">
            ...
            <button
                class="open-modal hover:text-(--primary) transition"
        ...
        <div id="guest-buttons" class="hidden md:flex gap-3">
            ...
            <button
                id="open-login"
                class="px-4 py-2 rounded-lg border border-(--primary)"
            >
                Connexion
            </button>
        ...
        >
            ...
            <button
                id="user-icon"
                type="button"
                class="rounded-full bg-(--primary) p-3 text-white"
            >
                👤
            </button>
            ...
            >
                ...
                <a
                    href="#account"
                    class="block rounded-lg px-3 py-2 hover:bg-(--background)"
                >
                    Mes réservations
                </a>
                ...
                <button
                    id="logout-button"
                    type="button"
                    class="mt-3 w-full rounded-lg bg-red-500 py-2 text-white"
                >
                    Déconnexion
                </button>
        ...
        <button
            ...
            type="button"
            class="md:hidden rounded-lg p-2 hover:bg-(--background) transition"
            aria-label="Menu"
        >
    ...
    >
        <div class="flex flex-col gap-4">
            ...
            <button
                class="open-modal hover:text-(--primary) transition py-2 text-left"
                data-modal="reservation-modal"
            >
                Réservation
            </button>

            <a href="#contact" class="hover:text-(--primary) transition py-2">
                Contact
            </a>
            ...
            <div class="border-t border-(--border) pt-4 mt-2 flex flex-col gap-3">
                ...
                <div id="mobile-guest-buttons" class="flex flex-col gap-3">
                    <button
                        id="mobile-open-login"
                        class="px-4 py-2 rounded-lg border border-(--primary) w-full"
                    >
                        Connexion
                    </button>

                    <button
                        id="mobile-open-signup"
                        class="px-4 py-2 rounded-lg bg-(--primary) text-white w-full"
                    >
                        Inscription
                    </button>
                </div>
