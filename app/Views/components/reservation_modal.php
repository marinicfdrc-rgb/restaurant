...
<div
class="flex h-[85vh] w-[95vw] max-w-7xl flex-col rounded-2xl bg-(--card) shadow-xl"
>
...
<form
id="reservation-form"
class="grid flex-1 grid-cols-12 overflow-hidden"
>
...
<div
class="col-span-6 flex flex-col overflow-hidden"
>
...
<div
class="col-span-3 flex flex-col border-l p-6"
>
...
<div
class="mb-4 flex justify-between text-xl font-bold"
>
